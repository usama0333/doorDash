...
function Component({ setShowOpt, inputData, setShowAccount, setShowHome  }) {
  ...
  return (
        <div className= 'h-full w-screen  flex flex-col justify-between '  >
              <div className=' bg-white p-5 sm:pr-7  flex  justify-end top-0 fixed w-screen   ' >
                <RxCross2 className=' right-0 text-2xl md:text-3xl cursor-pointer ' onClick={()=> { setShowHome(true); setShowOpt(false) } } />
              </div>
            <div className=' bg-white h-full w-full flex flex-col items-center my-16 md:mt-24 max-w-[480px] lg:max-w-[600px] mx-auto   ' >
              <div className=' mx-3 ' >
                <svg height="64px" width="64px" fill="#ffffff" x="0px" y="0px" viewBox="0 0 64 64">
                  ...
                  39.7494 17.0498 39.7494H22.0755C22.2026 41.2171 22.4884 42.6395 22.9154 43.9993Z" fill="#4969f5"></path>
                  ...
                  43.4142L48.4142 36.4142Z" fill="#4969f5"></path>
                  ...
                  35.3726 26 42 26C48.6274 26 54 31.3726 54 38Z" fill="#4969f5"></path>
                </svg>
              </div>
